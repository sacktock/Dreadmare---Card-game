...
Public Module MathFunc
    ...
    Public Function DiscreteRandomNumber(DiscreteValues() As Integer) As Integer
        If DiscreteValues(0) = 0 Then
            Return 0
        End If
        Return DiscreteValues(randomnumber(DiscreteValues.Length, 0))
    End Function
    ...
    Public Function isEqualTo(ByVal int1 As Integer, ByVal int2 As Integer)
        If int1 = int2 Then
            Return True
        Else
            Return False
...
Class queue
    ...
    Public Sub IntoQueue(Input As Integer)
        ...
        ReDim Preserve queuedata(queuedata.Length)
